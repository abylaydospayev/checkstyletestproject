...
public class BlackBoxTestEngine {
    ...
    @Test
    @DisplayName("Black Box Test: HalsteadCheck (Tests all 5 metrics)")
    public void testHalsteadCheck() throws Exception {

        String output = runCheck(new HalsteadCheck(), "src/test/resources/inputs/HalsteadInput.java");
        System.out.println("Halstead Black Box Output:\n" + output);
        
        assertTrue(output.contains("Halstead Length:"), "Should report Length");
        assertTrue(output.contains("Halstead Vocabulary:"), "Should report Vocabulary");
        assertTrue(output.contains("Halstead Volume:"), "Should report Volume");
        assertTrue(output.contains("Halstead Difficulty:"), "Should report Difficulty");
        assertTrue(output.contains("Halstead Effort:"), "Should report Effort");
    }
}